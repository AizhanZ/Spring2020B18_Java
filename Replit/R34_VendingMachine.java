...
public class R34_VendingMachine {
    ...
    public static void main(String[] args) {
        ...
        if((itemPrice >= 25 && itemPrice <= 100) && (itemPrice % 5 == 0 ) ){//is not divisible by 5
            int quarters = change / quarter;
            int dimes = (change % quarter) / dime;
            int nickels = ((change % quarter) % dime) / nickel;
