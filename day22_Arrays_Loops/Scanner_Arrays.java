 ...
 */
    public static void main(String[] args) {
        ...
        for( String each : arr){
            //String str = each.substring(0, 3);//can also put (0, 2+1)//prints first three characters
            String str = each.charAt(0) +""+ each.charAt(each.length()-1);//prints out first and last character
