...
public class NestedLoops {
    ...
    public static void main(String[] args) {
        ...
        for(int j = 0; j < arr2D.length; j++){//will be executed 3 times
            //j: index number of 1D array    i: index number of elements in 1D array
            for(int i = 0; i < arr2D[j].length; i++){
                System.out.println(arr2D[j][i]);//prints every single element in the array
            }
